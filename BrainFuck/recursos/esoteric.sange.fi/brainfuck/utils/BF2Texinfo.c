...
/*
 * Program Name:  BF2Texinfo
 * Version:       1.0
 * Date:          2003-03-18
 * Description:   Converts Brainfuck source to Texinfo
 * License:       GPL
 * Web page:      http://www.brainfuck.ca
 * Download:      http://www.brainfuck.ca/BF2Texinfo.c
...
int main(int argc, char **argv) {
  ...
  int args,            /* index of current argument   */
      ...
      new_line_cntr=1; /* counts characters before \n */
